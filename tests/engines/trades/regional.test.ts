...
import { buildEstimate } from "@/engines/trades/estimate";
import { applyRegional, regionalMultiplierBps } from "@/engines/trades/regional";
import { getTradeRules } from "@/engines/trades/rules";
import type { Job } from "@/engines/trades/types";
