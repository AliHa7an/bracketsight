...
export type Warning = {
  ...
  /**
   * Overrides the severity's own word ("Irreversible" / "Check this"). Colour
   * is never the sole carrier of meaning, so this label is doing real work: it
   * must name the category concretely ("Unverified pricing", "Template only"),
   * never soften it ("Note", "Heads up"). Defaults to the severity name, so
