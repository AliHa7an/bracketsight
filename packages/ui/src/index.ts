/**
 * @fineprint/ui — the design system, public surface.
 *
 ...
 *
 * Import surface:
 *   import { Button, LedgerTable, formatCents, useReducedMotion } from "@fineprint/ui";
 *
 ...
 *   import { formatCents, formatMonths } from "@fineprint/ui/format";
 *   import { DUR_BASE, prefersReducedMotion } from "@fineprint/ui/motion";
 * `@fineprint/ui/components/Button` also resolves, but prefer the barrel.
 *
