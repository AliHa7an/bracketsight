...
import type { PlanId, PlanResult, SimulationResult, Warning } from "@fineprint/engine-repayment";
import { PLAN_NAMES } from "@fineprint/engine-repayment";
import { LiveNumber } from "@fineprint/ui";
import { ScrubTrack } from "@fineprint/ui";
import { durationLabel, monthLabel, usd, usdExact } from "@fineprint/ui";
import { DUR_SIGNATURE, easeAtlas, prefersReducedMotion } from "@fineprint/ui";
import {
  balanceAt,
