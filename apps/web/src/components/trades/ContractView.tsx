...
import { formatCents, usd } from "@fineprint/ui/format";
import { saveContractFacts, useStoredContractFacts, useStoredEstimate } from "@/lib/trades/store";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="no-print flex flex-wrap gap-2">
        ...
        <Link href={`/trades/contracts/${stateRules.stateId}`}>
