...
import { formatCents, formatDate, formatPct, usd } from "@fineprint/ui/format";
import { DUR_BASE, DUR_SIGNATURE, prefersReducedMotion } from "@fineprint/ui/motion";
...
export default function TakeoffBuilder() {
  ...
  function goTo(path: "/trades/invoice" | "/trades/contract") {
  ...
  return (
    <div className="relative">
      <div className="takeoff-grid grid gap-6 lg:grid-cols-[minmax(0,15rem)_minmax(0,1fr)]">
        ...
        <section aria-labelledby="sheet-heading" className="min-w-0">
          ...
          <div className="no-print mt-4 flex flex-wrap gap-2">
            <Button variant="secondary" className="touch-lg" onClick={() => goTo("/trades/contract")}>
              Create the contract
            </Button>
            <Button
              variant="secondary"
      ...
      >
        ...
        />
        <Button className="touch-lg" onClick={() => goTo("/trades/invoice")}>
